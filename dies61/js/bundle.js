    ...
    $.fn.fsvs = function (options) {
        ...
        var app = {
            ...
            slideToIndex: function (index, e) {
                // deColorLinks(currentSlideIndex);
                // colorLinks(index);
                var e = e || false;
...
function colorLinks(nIndex) {
    switch (nIndex) {
        case 0 :
            //color: #40E0D0
            $('#title').animate({color: "#40E0D0"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
        case 1 :
            $('#buttonone').animate({color: "#40E0D0"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
        case 2 :
            $('#buttontwo').animate({color: "#40E0D0"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
        case 3 :
            $('#buttonthree').animate({color: "#40E0D0"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
...
function deColorLinks(oIndex) {
    switch (oIndex) {
        case 0 :
            $('#title').animate({color: "#9D9D9D"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
        case 1 :
            $('#buttonone').animate({color: "#9D9D9D"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
        case 2 :
            $('#buttontwo').animate({color: "#9D9D9D"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
        case 3 :
            $('#buttonthree').animate({color: "#9D9D9D"}, {
                easing: 'easeOutQuad',
                duration: 600
            });
            break;
