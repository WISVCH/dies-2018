...
$(document).ready(function () {
    $('#chairman').hover(function () {
        handleCommitteeHover("Arthur");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
    $('#secretary').hover(function () {
        handleCommitteeHover("Danique");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
    $('#treasurer').hover(function () {
        handleCommitteeHover("Erik");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
    $('#promotion').hover(function () {
        handleCommitteeHover("Michaël");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
    $('#purchase').hover(function () {
        handleCommitteeHover("Irene");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
    $('#planning').hover(function () {
        handleCommitteeHover("Iris");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
    $('#qq').hover(function () {
        handleCommitteeHover("Ridder Tommie");
    }, function () {
        handleCommitteeHover("AnarCHy");
    });
...
function loadProgram(index) {
    ...
    switch (index) {
        ...
        case 8 :
        {
            detailsPath = "programPages/pubCrawlDetails.html";
        ...
        case 10 :
        {
            detailsPath = "programPages/workshopDetails.html";
        ...
        case 12 :
        {
            detailsPath = "programPages/breakfastDetails.html";
            break;
        }
        case 13 :
        {
