...
?>
    ...
    <head lang="en">
        ...
        <!-- FSVS CSS -->
        <link href="css/fsvs-style.css" media="all" rel="stylesheet" type="text/css"/>
        <!-- Javascript -->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" id="navbar" role="navigation">
        <div class="container">
            <div class="navbar-header">
                <a id="title" class="navbar-brand" onclick="slider.slideToIndex(0)">AnarCHy - Dies 2016</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="navbarButton" id="buttonone" href="#" onclick="slider.slideToIndex(1)">Updates</a>
                    </li>
                    <li>
                        <a class="navbarButton" id="buttontwo" href="#" onclick="slider.slideToIndex(2)">Program / Sign
                            Up</a>
                    </li>
                    <li>
    ...
    <div class="slide" id="splash">
        ...
        <h2>The yearly purge has commenced</h2>
