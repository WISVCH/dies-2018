...
//dagen tot de Dies-week!!</p>";
		  ...
		  <ul>
			 ...
			 <a href="http://www.tamtam.nl/"><img src="images/tamtam.gif" width="84" height="129" /></a>
                ...
                <div id="right">
                    <?php 
						if($_GET['page'] == "" || $_GET['page'] == "programma" ||$_GET['page'] == "commissie" || $_GET['page'] == "contact" || $_GET['page'] == "gotcha" || $_GET['page'] == "beermile"){
...
echo "<br /><br /><br /><center><h1><font color='black'>THE GAME!</font></h1></center>";
            ...
            <div id="footer">
                <p>Copyright &copy; 54<sup>ste</sup> Dies Commissie der 
